// FILE: components/WebinarHomeSection.tsx
        ...
        <div className="grid md:grid-cols-2 gap-12 items-center">
          ...
          <div>
            ...
            <p className="text-xl text-white/90 mb-6">
              {currentWebinar.description.substring(0, 150)}...
            </p>
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              <a
                ...
                className="inline-block text-center bg-white text-primary-700 font-bold px-8 py-4 rounded-xl hover:bg-gray-50 transition-all shadow-lg hover:shadow-xl"
              >
                Register for Free →
              </a>
              ...
              <Link
                href="/webinars"
                className="inline-block text-center bg-white/10 backdrop-blur-sm border-2 border-white/30 text-white font-semibold px-8 py-4 rounded-xl hover:bg-white/20 transition-all"
              >
                Learn More
              </Link>
            </div>
            ...
            <p className="text-sm text-white/70 mt-4">
              ✓ Live Q&A • ✓ Recording Available • ✓ Certificate of Attendance
            </p>
          </div>
          ...
          <div className="relative">
            <div className="bg-white/10 backdrop-blur-lg rounded-2xl p-8 border border-white/20 shadow-2xl">
              ...
              <div className="mt-6 space-y-2">
                ...
                <div className="text-white/60 text-xs pt-2">+ {currentWebinar.topics.length - 3} more topics</div>
              </div>
            </div>

            {/* Floating Badge */}
            <div className="absolute -top-4 -right-4 bg-yellow-400 text-gray-900 font-bold px-4 py-2 rounded-lg shadow-lg transform rotate-6">
              FREE
            </div>
          </div>
        </div>
